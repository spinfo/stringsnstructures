...
public class KwipXmlStreamReader extends DefaultHandler {
	...
	private static Logger logger = Logger.getLogger(KwipXmlStreamReader.class
			.getSimpleName());
	private static InputStream xmlInStream;
	private Tags iState = Tags.UNDEFINED;
	private Type currentType;
	private Token currentToken;
	private List<Type> types;

	public KwipXmlStreamReader(InputStream xmlInputStream) {
		KwipXmlStreamReader.xmlInStream = xmlInputStream;
	}
	...
	public List<Type> read() {
		...
		try {
			...
			saxParser.parse(xmlInStream, this);
